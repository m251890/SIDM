...
hist_defs = {
    ...
    "electron_GsfEleDPhiInCut": h.Histogram(
        [
            h.Axis(hist.axis.Regular(60, 0, .2, name="electron_GsfEleDPhiInCut"),
    ...
    "electron_GsfEleRelPFIsoScaledCut": h.Histogram(
        [
            h.Axis(hist.axis.Regular(80, 0, .2, name="electron_GsfEleRelPFIsoScaledCut"),
    ...
    "electron_GsfEleFull5x5SigmaIEtaIEtaCut": h.Histogram(
        [
            h.Axis(hist.axis.Regular(60, 0, .045, name="electron_GsfEleFull5x5SigmaIEtaIEtaCut"),
    ...
    "genE_genE_dR": h.Histogram(
        [
            ...
            h.Axis(hist.axis.Regular(200, 0, 1.0, name="genE_genE_dR",
